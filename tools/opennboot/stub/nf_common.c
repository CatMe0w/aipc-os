 ...
 * The read path never touches it. A write must set it, then clear it after. */
...
/* Word stores only. A STRB into L2 SRAM spreads the byte across the whole word. */
 ...
 * reach them would use one more partial page program. The NOP limit of this
 * part is unknown. */
