...
Commands are 64-byte frames with a fixed sync pattern, header/tail magic, and a one-byte opcode. See [protocol.py](src/ak7802_usbboot/protocol.py) for the full frame layout and opcode table.
