...
#define NF_PAGE_RAW  2112u      /* whole physical page; read captures it, write does not */
 ...
 * (1.88 device), so it ends at 0x30162000, clear of the log buffer at 0x301F0000. */
