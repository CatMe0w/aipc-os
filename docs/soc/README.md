...
- [LCD](lcd.md): the display controller at `0x20010000`. Register model, the pixel clock formula and the rates it reaches, how to pan, how to restart it after a failure, frame buffer mapping, and the panel and backlight on this board.
